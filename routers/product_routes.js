...
const { addproducts, viewproducts, upload, updateProduct, deleteproduct, singleproduct, updatestock } = require('../controllers/product_controller');
...
router.route("/updatestock").put(updatestock);
